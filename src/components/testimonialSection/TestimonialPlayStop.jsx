  ...
  return (
    <div className="order-2 md:order-4 grow md:basis-full flex justify-center">
      <div className="relative rounded-full overflow-hidden">
        <div className="absolute bg-charcoal inset-0 z-0"></div>
        <div className={`absolute z-20 bg-steel-blue inset-0 ${reset? "translate-x-[-100%]" : "translate-x-0 transition duration-[5200ms] linear "}`}></div>
        <TestimonialButton
