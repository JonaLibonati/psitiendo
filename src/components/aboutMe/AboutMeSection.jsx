    ...
    <Section id="sobre-mi" headline={"SOBRE MÍ"} subheadline={"Conoce quién soy, mi camino y lo que me inspira a acompañar"} pBottom="pb-0" >
      <div className="relative flex flex-wrap justify-center">
        <div className="absolute flex justify-center">
          <img src={paper} className="m-auto h-[910px] md:max-h-[760px] md:w-[1000px] max-w-none object-fill" alt="Fondo decorativo de papel" loading="lazy" />
        </div>
        ...
        <div className="relative flex w-full md:pb-[50px]">
          <AboutMePostIt img={postItLeft.imgLeft} onClick={() => handlePostItclick(postItLeft, "left")} justify="md:justify-end" ariaLabel="Ver contenido de la nota adhesiva izquierda" alt="Nota adhesiva izquierda" />
          <AboutMePostIt img={postItRight.imgRight} onClick={() => handlePostItclick(postItRight, "right")} justify="md:justify-start" ariaLabel="Ver contenido de la nota adhesiva derecha" alt="Nota adhesiva derecha" />
        </div>
      </div>
    </Section>
